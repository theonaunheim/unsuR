...
Tool Developer: Corey Neskey, CISSP | cneskey@protonmail.com | [github.com/cneskey](https://github.com/cneskey) | [linkedin.com/in/cneskey](https://linkedin.com/in/cneskey) | [twitter.com/cneskey](https://twitter.com/cneskey) | [cneskey.githib.io/unsur](https://cneskey.github.io/unsuR/)
...
### Inputs
Input source: `r sheeturl`

```{r Inputs_summary_table}
options(knitr.kable.NA = '')
derp <- gSumstats
kable(derp, format = "html", caption = "Inputs Summary") %>%
  kable_styling(bootstrap_options = "striped",
                full_width = T)
```
