...
![](companion_spreadsheet_Google.png)
...
![](companion_spreadsheet_Microsoft.png)
...
![](control_droids.png)
*e.g. The Droid restraining bolt is an applicable control to the Threat Community entries that contain "droid".*
...
![](analysis_plots_snapshot.png)



**Reporting / Communication**

Conclusions and recommendations may be communicated alone or alongside visuals by entering the desired text into the Commentary tab of the spreadsheet.

![](commentary_tab.png)



This article uses material from the “Death Star plans”, "Geonosian", "Orson_Callan_Krennic", and "Galen Walton Erso" articles on the [Star Wars wiki at Fandom](https://starwars.fandom.com/wiki/Main_Page) and is licensed under the Creative Commons Attribution-Share Alike License.
