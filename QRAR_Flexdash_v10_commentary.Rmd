...
*FAIR Scope Table Example*

Assets at risk | Containers/Points of attack | Agent/Threat Community |	Threat Types | Threat Effects
------------ | ------------- |------------- | ------------- | -------------
ePHI |	Entity purchased desktops logged into by power users	| privileged insiders (employees & Vendors) | deliberately | confidentiality |
PII | personal desktops and laptops logged into by power users | non-privileged insiders (employees & vendors) | accidentally | integrity |
PCI | public desktops and laptops logged into by power users	| malicious software | | availability |
|  | Entity purchased laptops and mobile devices logged into by power users	| external attackers |
|  | personal laptops and mobile devices logged into by power users | auditor
|  | Public laptops and mobile devices logged into by power users |	 
|  | Media server |	 	 	 
|  | File Shares |	 	 	 
|  | USB Sticks  |
...
Monte Carlo Simulation is used to generate a dataset using the parameters provided. The simulations consist of at least 10,000 variations of each loss scenario. The resulting approximating dataset may then be analyzed using appropriate statistical methodologies.
...
- nn scenarios were generated by exhausting...
- nn were disregarded.
